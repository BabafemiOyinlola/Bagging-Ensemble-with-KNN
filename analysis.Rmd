...
```{r}
iono_base_metrics_df <- data.frame(iono_base_metrics)
iono_lib_metrics_df <- data.frame(iono_lib_metrics)
...
bc_base_metrics_df <- data.frame(bc_base_metrics)
bc_lib_metrics_df <- data.frame(bc_lib_metrics)
