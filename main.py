...
print("Accuracy base: ", accuracies_ens)
print("Error base: ", errors_ens)
print("Precision base: ", precisions_ens)
print("Recall base: ", recalls_ens)
print("Fscore base: ", fs_ens)
print("Specificity base: ", specificity_ens)


print("\n\n")

print("Accuracy lib: ", accuracies)
print("Error lib: ", errors)
print("Precision lib: ", precisions)
print("Recall lib: ", recalls)
print("Fscore lib: ", fs)
print("Specificity lib: ", specificity)
#=========================================================================================================================#
#=========================================================================================================================#
#=========================================================================================================================#
#=========================================================================================================================#
...
print("Accuracy base2: ", accuracies_ens)
print("Error base2: ", errors_ens)
print("Precision base2: ", precisions_ens)
print("Recall base2: ", recalls_ens)
print("Fscore base2: ", fs_ens)

print("\n\n")

print("Accuracy lib2: ", accuracies)
print("Error lib2: ", errors)
print("Precision lib2: ", precisions)
print("Recall lib2: ", recalls)
print("Fscore lib2: ", fs)
